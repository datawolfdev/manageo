                    ...
                    <div className={`p-6 space-y-4 md:space-y-6 sm:p-8`}>
                        ...
                        <form className={`space-y-4 md:space-y-6`} method="POST">
                            <div>
                                ...
                                <input onChange={(e) => setEmail(e.target.value)} type="email" name="email" id="email" className={`bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5`} placeholder="name" required="" />
                            </div>
                            <div>
